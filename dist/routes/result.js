            ...
            switch (path) {
                ...
                case "tastes":
                    for (let i = 0; i < result.length; i++) {
                        ...
                        if (contentModels.tastes[i].a[score].answer === friendResult.desc[i]) {
                            resultDesc[i] = `맞았어요! 친구도 ${contentModels.tastes[i].a[score].answer}를 선택했네요!`;
                        }
                        else {
                            resultDesc[i] = `틀렸어요...! 친구는 ${contentModels.tastes[i].a[score].answer}를 선택했어요...!`;
                        }
                    }
                    break;
                //TODO: need to imple
